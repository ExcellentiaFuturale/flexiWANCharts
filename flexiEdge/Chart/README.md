...
| `ethernets.cni0.routes`                       | Enable or Disable getting Default Gateway via DHCP (optional)   | `true`                 |
...
| `ethernets.cni1.routes`                       | Enable or Disable getting Default Gateway via DHCP (optional)   | `true`                 |
