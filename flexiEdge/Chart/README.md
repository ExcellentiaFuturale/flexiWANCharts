...
| `ethernets.cni0.dhcp.routes`                  | Enable or Disable getting Default Gateway via DHCP (optional)   | `true`                 |
...
| `ethernets.cni1.dhcp.routes`                  | Enable or Disable getting Default Gateway via DHCP (optional)   | `true`                 |
